...
public class Wolfram158GrpcKVClusterImpl implements KVCluster {
    private static final Logger log = LoggerFactory.getLogger(Wolfram158GrpcKVClusterImpl.class);
    private final List<String> endpoints;
    private final Map<String, GrpcKVServiceImpl> endpointToKVService;
    private final KVServiceFactory factory;
    private final Router router;

    public Wolfram158GrpcKVClusterImpl(List<String> endpoints, KVServiceFactory factory) throws IOException,
        ...
        for (String endpoint : endpoints) {
            final GrpcKVServiceImpl service = (GrpcKVServiceImpl) factory.create(Utils.extractPort(endpoint));
    ...
    private void createNewService(String endpoint) {
        try {
            final var newService = (GrpcKVServiceImpl) factory.create(Utils.extractPort(endpoint));
