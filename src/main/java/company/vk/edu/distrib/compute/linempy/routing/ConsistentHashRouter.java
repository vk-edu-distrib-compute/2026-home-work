...
/**
 * Consistent hashing с виртуальными нодами.
 *
 * <p>
 * Ноды размещаются на кольце, ключ ищет ближайшую ноду по часовой стрелке.
 * Виртуальные ноды (150 шт) обеспечивают равномерное распределение.
 *
 * @author Linempy
 * @since 17.04.2026
 */
