...
import company.vk.edu.distrib.compute.andrey1af.sharding.Andrey1afKVClusterFactoryImpl;
...
public class Server {
    ...
    void main(String... args) throws IOException {
        ...
        if (isClusterMode(args)) {
            ...
            KVCluster cluster = new Andrey1afKVClusterFactoryImpl().create(ports);
            cluster.start();
