...
import company.vk.edu.distrib.compute.wedwincode.sharded.EdwinRendezvousKVClusterFactory;
...
public class Server {
    ...
    void main(String... args) throws IOException {
        ...
        if (isClusterMode(args)) {
            ...
            KVCluster cluster = new EdwinRendezvousKVClusterFactory().create(ports); // todo
            cluster.start();
