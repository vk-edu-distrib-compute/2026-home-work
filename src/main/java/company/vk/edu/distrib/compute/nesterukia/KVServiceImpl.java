...
public class KVServiceImpl implements KVService {
    ...
    public KVServiceImpl(int port, Dao<byte[]> dao, Router router) throws IOException {
    ...
    private void initService() {
        ...
        server.createContext(BASE_URI.concat(ENTITY_URI), new ErrorHttpHandler(http -> {
            ...
            if (shouldBeHandledByThisNode(entityId)) {
    ...
    private boolean shouldBeHandledByThisNode(String key) {
        return router == null || Objects.equals(router.getNode(key), this);
    }
